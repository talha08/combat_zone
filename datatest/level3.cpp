...
{
    char bname[25];
    coor player, enemy[2], pshot[25], enshot[2];
    int plife=3, enlife[2]={7,7};
    int fb =0, input, bo=0;
    player.xl= 20, player.yt=200, player.xr=100, player.yb=300;
    enemy[0].xl=650, enemy[0].yt=100, enemy[0].xr=730, enemy[0].yb=200;
    enemy[1].xl= 650, enemy[1].yt=350, enemy[1].xr=730, enemy[1].yb=450;
